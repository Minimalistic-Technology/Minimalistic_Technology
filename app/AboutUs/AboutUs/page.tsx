...
// 1️⃣ Import & initialize Poppins
const poppins = Poppins({
  weight: ["400", "600", "700"],
  subsets: ["latin"],    // add "latin-ext" if you need accented characters
  display: "swap",
});
...
const AboutUs = () => {
  ...
  return (
    // 2️⃣ Apply poppins.className here
    <div className={`${poppins.className} bg-[#222222] min-h-screen text-white`}>
      <header className="fixed top-0 left-0 w-full z-50 bg-[#222222]/10 backdrop-blur-xl text-white p-4 md:flex md:justify-between md:items-center">
        ...
        <div className="hidden md:flex space-x-2">
          <button className="px-4 py-2 border bg-green-600 text-white rounded-lg hover:bg-green-400 hover:text-white transition">
            Get Started
          </button>
        </div>
      </header>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 bg-[#222222] mt-7 text-white">
        <div className="text-center md:text-left md:w-1/2">
          ...
          <button className="mt-6 px-6 py-3 bg-green-500 text-white rounded-lg font-bold hover:bg-green-600 transition">
            Start Building
          </button>
        </div>
      ...
      <section>
        <div className="text-white text-center text-3xl mt-10">Our Services</div>
        <div className="flex justify-center overflow-x-auto lg:space-x-15 sm:space-x-15 p-4 mt-7 mb-7 scrollbar-hide w-full">
          {images.map((src, index) => (
            ...
            >
              <Image src={src} alt="our services" width={300} height={100} className="w-[80vw] sm:w-[350px] h-auto rounded-lg" />
            </motion.div>
          ))}
        </div>
      ...
      <div className="flex flex-col items-center justify-center text-center mt-10">
        <div className="w-full max-w-full bg-gradient-to-r from-transparent via-green-400 to-green-700 py-10 shadow-lg">
          <p className="text-4xl text-white font-semibold">Let's build something amazing together</p>
          <button className="bg-green-500 text-xl text-white rounded-lg mt-10 py-3 px-6 shadow-md">Get Started</button>
        </div>
      </div>
      ...
      <footer className="bg-[#222222] text-white">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-white flex space-x-4 text-start mt-7 md:mt-0">@ 2025 Minimilistic Technology All Rights Reserved</div>
          <div className="flex space-x-4 justify-end mt-4 mb-5 md:mt-0">
            <a href="#" className="hover:text-white transition">
              <FaFacebook size={24} />
            </a>
            <a href="https://x.com/TechMinimalists" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
              <FaTwitter size={24} />
            </a>
            <a href="https://www.instagram.com/minimalistictechnology" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
              <FaInstagram size={24} />
            </a>
            <a href="https://www.linkedin.com/showcase/minimalistictechnology/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">
              <FaLinkedin size={24} />
            </a>
            <a href="#" className="hover:text-white transition">
              <FaYoutube size={24} />
