...
const Get: React.FC = () => {
  ...
  return (
    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-[#23272A]/90 backdrop-blur-md  text-white p-4 md:flex md:justify-between md:items-center">
      ...
      <section className="mt-22 text-bklack  text-center px-4">
                  ...
                  <h3 className="text-2xl font-bold p-3">Project Information</h3>
                   <div className="grid grid-cols-1 gap-4">
                    ...
                    <select
                      ...
                      <option className="bg-[#23272A] text-white" value="web-design">Web Design</option>
                      <option className="bg-[#23272A] text-white" value="erp">Hosting</option>
                      <option className="bg- text-white" value="ecommerce">E-commerce site</option>
                    </select>
