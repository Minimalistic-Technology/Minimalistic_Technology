...
import { Rocket, Palette, Code, GraduationCap, Cpu, Zap, Headset, Mail, ArrowRight, Star, Globe, Shield } from 'lucide-react';
        ...
        <div className="bg-[var(--background)] text-[var(--text-main)]">
            ...
            <section className="py-20">
                <div className="site-container">
                        ...
                        {steps.map((step, i) => (
                            <React.Fragment key={i}>
                                ...
                                >
                                    ...
                                    <h3 className="text-center text-[var(--text-main)] font-bold text-lg tracking-tight">{step.label}</h3>
                                </motion.div>
                                {i < steps.length - 1 && (
                    ...
                    >
                        <h2 className="text-[2.5rem] font-black text-[var(--text-main)] mb-4">Launch Your Idea</h2>
